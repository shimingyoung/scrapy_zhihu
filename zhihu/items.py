...
import scrapy
import datetime
SQL_DATETIME_FORMAT = '%m/%d/%Y %H:%M:%S'
...
class ZhihuQuestionItem(scrapy.Item):
    ...
    def get_insert_sql(self):
        ...
        print("NUM:".join(self["answer_num"]))
        answer_num = self.extract_num("".join(self["answer_num"]))
        comments_num = self.extract_num("".join(self["comments_num"]))
